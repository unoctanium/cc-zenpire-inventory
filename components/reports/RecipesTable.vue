        ...
        >
          ...
          <thead class="sticky top-0 z-20 bg-white dark:bg-gray-950">
            <tr>
              ...
              <th class="px-2 py-1.5 text-left font-medium text-gray-700 dark:text-gray-200 border-b border-gray-200 dark:border-gray-800">{{ $t('recipes.compCost') }}</th>
              <th class="px-2 py-1.5 text-left font-medium text-gray-700 dark:text-gray-200 border-b border-gray-200 dark:border-gray-800">{{ $t('recipes.unitCost') }}</th>
              ...
              <th class="px-2 py-1.5 text-left font-medium text-gray-700 dark:text-gray-200 border-b border-gray-200 dark:border-gray-800">{{ $t('recipes.preProduct') }}</th>
              <th class="px-2 py-1.5 text-left font-medium text-gray-700 dark:text-gray-200 border-b border-gray-200 dark:border-gray-800">{{ $t('recipes.components') }}</th>
            </tr>
          </thead>
          ...
          <tbody>
            ...
            <tr v-for="row in visibleRows" :key="row.id"
              ...
              <td class="px-2 py-1.5 align-middle"><span class="text-gray-800 dark:text-gray-200">{{ row.output_quantity }} {{ row.output_unit_code }}</span></td>
              <td class="px-2 py-1.5 align-middle">
                <span class="text-gray-800 dark:text-gray-200"
                  :class="row.comp_cost != null && row.standard_unit_cost != null && row.comp_cost > row.standard_unit_cost * row.output_quantity
