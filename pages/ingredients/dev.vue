...
<template>
  ...
  <AdminTableShell v-else :error-text="errorText">
    ...
    <template #table>
      <!--
        Layout:
        · Left  (Name, 220px)    — sticky, always visible, fits ~30 chars + sort icon
        · Middle (Kind 100px, Unit 140px, Cost 120px, Currency 64px) — scroll area
        · Right (Actions, 72px)  — sticky, always visible
        Cell padding: px-2 py-1.5 throughout
      -->
      <div class="overflow-x-auto">
        <table class="w-full table-fixed border-separate border-spacing-0 text-sm">
          <colgroup>
            <col style="width: 220px" />  <!-- Name — sticky left -->
            <col style="width: 100px" />  <!-- Kind — scrollable -->
            <col style="width: 140px" />  <!-- Default unit — scrollable, dropdown -->
            <col style="width: 120px" />  <!-- Std cost — scrollable, number input -->
            <col style="width: 64px"  />  <!-- Currency — scrollable, short text -->
            <col style="width: 72px"  />  <!-- Actions — sticky right -->
          </colgroup>
          ...
          <tbody>
            ...
            >
              <!-- NAME — sticky left -->
              <td class="sticky left-0 z-10 px-2 py-1.5 align-middle
                         bg-white dark:bg-gray-950
                         border-r border-gray-200 dark:border-gray-800">
              ...
              <!-- KIND — scrollable, always read-only -->
              ...
              <!-- CURRENCY — scrollable, always read-only -->
              <td class="px-2 py-1.5 align-middle">
                <span class="text-gray-500 dark:text-gray-400">{{ row.standard_cost_currency }}</span>
              </td>

              <!-- ACTIONS — sticky right -->
              <td class="sticky right-0 z-10 px-2 py-1.5 align-middle text-right
                         bg-white dark:bg-gray-950
                         border-l border-gray-200 dark:border-gray-800">
